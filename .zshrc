...
export POWERLEVEL9K_TIME_FORMAT="\UF43A %D{%I:%M  \UF133  %d.%m.%y}"
...
export POWERLEVEL9K_OS_ICON_BACKGROUND='red'
export POWERLEVEL9K_OS_ICON_FOREGROUND='white'
export POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(context os_icon ssh root_indicator dir dir_writable vcs)
